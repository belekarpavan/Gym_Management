...
<%@ include file="index.jsp" %>  
	 <div class="container">
    <h4><strong><center>Member Attendance</center></strong></h4>
    <div class="row">
  ...
  <div class="col-lg-4 col-sm-4 col-sx-4">
    <div class="form-group">
      <label for="Gym">Select Shift</label>
                ...
                <select class="form-control select2" style="width: 100%;">
                  <option selected="selected">8:00:AM to 9:00:AM</option>
                  <option>Aerobics</option>
                  <option>Dance</option>
                  <option>weight lifting and strength training</option>
  ...
  <tbody>
    <tr>
      ...
      <td> <label class="radio-inline">
       <input type="radio" name="optradio" value="Present">Present
    </label>
